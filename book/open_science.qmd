...
| Repository name                 | URL                                  | Purpose                                             | Open for contriutions     |
|:--------------------------------|:-------------------------------------|:----------------------------------------------------|:--------------------------|
...
There exists packages for many of these repositories, to include data hosted there in reproducible workflows (see @sec-reproducible). An example for Zenodo is shown below.
```{r eval = FALSE}
library(zen4R)
...
* This allows clear versioning through a [*tag*](https://git-scm.com/book/en/v2/Git-Basics-Tagging) and [*release*](https://docs.github.com/en/repositories/releasing-projects-on-github/managing-releases-in-a-repository) and allows tracking the state of the data through the *commit* history.
...
* Extend the repository to make in [*library*](https://r-pkgs.org/) (Example: [*leaf13C*](https://traitecoevo.r-universe.dev/leaf13C)).
...
* Use a git [*tag*](https://git-scm.com/book/en/v2/Git-Basics-Tagging) to mark major updates of the repository. These may align with designated version names (e.g., `v1.0.0`).
* Follow [*semantic versioning*](https://semver.org/) -- a standardised way of using version numbering to designate major, minor, and patch changes to the code.
* Create [*releases*](https://docs.github.com/en/repositories/releasing-projects-on-github/managing-releases-in-a-repository) of tags on GitHub or GitLab with notes describing changes.
* Link your Github repository to Zenodo for automatic DOI assignment when releasing a version (see [here](https://help.zenodo.org/docs/profile/linking-accounts/) and [here](https://help.zenodo.org/docs/github/enable-repository/)).
...
* Keep track of [*issues*](https://docs.github.com/en/issues/tracking-your-work-with-issues/learning-about-issues/about-issues) for bug reports and feature requests.
...
<!-- Due to the added complexity of the {targets} package, we will not include extensive examples of such a workflow but refer to the excellent documentation of the package for simple examples [here](https://books.ropensci.org/targets/walkthrough.html). -->
