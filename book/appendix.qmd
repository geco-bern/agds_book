...
# terra::plot(sand)
readLines(file.path(tempdir(), "T_SAND.nc"), warn = FALSE) == "Format netcdf4 is not supported for Grid data request" # TODO: fix this
```
...
# we need to load the {terra}
# library
# sand <- terra::rast(file.path(tempdir(), "T_SILT.nc"))
# terra::plot(sand)
readLines(file.path(tempdir(), "T_SAND.nc"), warn = FALSE) == "Format netcdf4 is not supported for Grid data request" # TODO: fix this
```
