...
###TODO: fix this on CI: # download data using the
###TODO: fix this on CI: # API endpoint and query data
###TODO: fix this on CI: status <- httr::GET(
###TODO: fix this on CI:   url = url,
###TODO: fix this on CI:   query = query,
###TODO: fix this on CI:   httr::write_disk(
###TODO: fix this on CI:     path = file.path(tempdir(), "T_SAND.nc"),
###TODO: fix this on CI:     overwrite = TRUE
###TODO: fix this on CI:   )
###TODO: fix this on CI: )
###TODO: fix this on CI: 
###TODO: fix this on CI: # to visualize the data
###TODO: fix this on CI: # we need to load the {terra}
###TODO: fix this on CI: # library
###TODO: fix this on CI: sand <- terra::rast(file.path(tempdir(), "T_SAND.nc"))
###TODO: fix this on CI: terra::plot(sand)
```
...
###TODO: fix this on CI:   query = query,
###TODO: fix this on CI:   httr::write_disk(
###TODO: fix this on CI:     path = file.path(tempdir(), "T_SILT.nc"),
###TODO: fix this on CI:     overwrite = TRUE
###TODO: fix this on CI:   )
###TODO: fix this on CI: )
###TODO: fix this on CI: 
...
###TODO: fix this on CI: # we need to load the {terra}
###TODO: fix this on CI: # library
###TODO: fix this on CI: silt <- terra::rast(file.path(tempdir(), "T_SILT.nc"))
###TODO: fix this on CI: terra::plot(silt)
```
...
###TODO: fix this on CI: hwsdr::ws_subset(
###TODO: fix this on CI:   location = c(45.5, 5.9, 48, 10.7),
###TODO: fix this on CI:   param = "T_SAND",
###TODO: fix this on CI:   path = tempdir()
###TODO: fix this on CI: )
###TODO: fix this on CI: 
###TODO: fix this on CI: # to visualize the data
###TODO: fix this on CI: # we need to load the {terra}
