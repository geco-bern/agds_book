...
@sec-primers serve as a primer to get readers with a diverse background and varying data science experience up to speed with the basics for programming in R, which we rely on in later chapters.

@sec-reproducible, @sec-openscience, and @sec-codemgmt introduce the motivation, concepts, and practices for reproducible and reusable workflows and Open Science.
