...
![The Venn diagram of data science. Adapted from [Conway, 2013](http://drewconway.com/zia/2013/3/26/the-data-science-venn-diagram).](./figures/data_science_venn_mine.png){#fig-datasciencevenn}
...
![The data science workflow. Figure adapted from: [Wickham and Grolemund *R for Data Science*](https://r4ds.had.co.nz/index.html)](./figures/data_science_workflow_simpl.png){#fig-datascienceworkflowslim}
