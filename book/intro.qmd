...
- Hadley Wickham and Garrett Grolemund: "R for Data Science", https://r4ds.had.co.nz/
    ...
    - A comprehensive resource for data analysis (and visualisation) using R *tidyverse*. Covers contents of Chapters @sec-primers and @sec-datawrangling -- but in more depth.
