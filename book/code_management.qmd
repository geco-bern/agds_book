...
-  Person 2 - Create a new file in the forked project

-  Person 2 - Commit and push these changes to the forked project. Create a **pull request** to the original project of Person 1.

-  Person 1 - Review the pull request from Person 2. Provide some comments, accept the pull request, letting the new code by Person 2 be integrated into the project.
