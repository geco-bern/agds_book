...
> The object `df_mae` is created above, recording metrics determined on the training and the validation set for differen choices of $k$. The respective code is hidden for the book. Explore the source code [here](https://github.com/geco-bern/agds_book/blob/d051ea902287a647419a11e7c6eb619a82d4a23b/book/supervised_ml_II.qmd#L156).
